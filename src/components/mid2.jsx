...
const mid2 = () => {
	return (
		<div className="relative h-screen w-screen flex flex-col bg-black items-center justify-between md:justify-start py-10 gap-4">
			...
			<img src="../../assets/bg.jpg" className="bgAnim absolute h-full right-0 z-0 top-1/2 -translate-y-1/2" alt=""/>
			<div className="z-10 md:h-1/3 md:w-1/3 w-full px-2">
				<img className="animeImgg h-fit w-full object-cover" src="../../assets/ram_mandir_demo.jpg" alt=""/>
			</div>
		</div>
	)
}
